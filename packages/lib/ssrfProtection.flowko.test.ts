...
import { isPrivateIP, validateUrlForSSRF, validateUrlForSSRFSync } from "./ssrfProtection";
...
describe("Flowko: isPrivateIP allows only global unicast", () => {
  it.each([
    ["::7f00:1", "IPv4-compatible loopback"],
    ["::a9fe:a9fe", "IPv4-compatible metadata"],
    ["::808:808", "IPv4-compatible, even of a public address"],
    ["64:ff9b::a9fe:a9fe", "NAT64 of metadata"],
    ["64:ff9b::a00:1", "NAT64 of 10.0.0.1"],
    ["64:ff9b:1::a00:1", "local-use NAT64 prefix"],
    ["::ffff:0:a9fe:a9fe", "SIIT of metadata"],
  ...
  it.each(["8.8.8.8", "93.184.215.14", "2606:4700::1111", "::ffff:8.8.8.8", "64:ff9b::808:808", "2002:808:808::1"])(
    "allows public %s",
    (ip) => {
  ...
  it("refuses those ranges as literal URL hosts and as DNS answers", async () => {
    expect(validateUrlForSSRFSync("https://[64:ff9b::a9fe:a9fe]/").isValid).toBe(false);
    expect(validateUrlForSSRFSync("https://[::7f00:1]/").isValid).toBe(false);
    lookupMock.mockResolvedValue([{ address: "2002:a00:1::1", family: 6 }]);
    expect(await validateUrlForSSRF("https://tunnel.attacker.example/")).toEqual({
      isValid: false,
      error: "Hostname resolves to private IP",
    });
  });
